...
var config = {
    ...
    APM_AGENT_TRANSACTION_SAMPLE_RATE:getConfig("APM_AGENT_TRANSACTION_SAMPLE_RATE", "0.01"),
    ...
    MONGO_DB_ROTADOR_EXPIRATION_IN_DAYS: getConfig("MONGO_DB_ROTADOR_EXPIRATION_IN_DAYS"),
    MONGO_DB_SIGNINGS_EXPIRATION_IN_DAYS: getConfig("MONGO_DB_SIGNINGS_EXPIRATION_IN_DAYS"),
