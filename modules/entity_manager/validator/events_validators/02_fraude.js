...
var validator = {
    ...
    doValidate: function (objectToValidate, contextToValidateWith) {
        return new Promise(function (resolve, reject) {
            log(`Running validation ${NAME} on Events for Click ${objectToValidate.click}`)
            ...
            if (fraude != '') { 
                const result = {
                    fraude: fraude,
                    Description: `Valido tr_sub1 si existe Fraude como evento`
                }
                ...
                const result = {
                    Description: `Valido tr_sub1, no existe Fraude como evento`
                }
