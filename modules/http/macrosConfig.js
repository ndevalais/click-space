...
module.exports = {
   ...
   trace_id: '<%= param.insertedClickId %>', 
   click_id: '<%= context.click.ClickID %>',
   Click_ID: '<%= context.click.ClickID %>',
   Click_ID: '<%= context.click.ClickID %>',
   SubPubID: '<%= param.subpubid %>',
   subpub_id: '<%= param.subpubid %>',
   ...
   IDFA: '<%= param.idfa %>',
   idfa: '<%= param.idfa %>',
   tr_sub1: '<%= context.click.ExtraParams.tr_sub1 %>',
   tr_sub2: '<%= context.click.ExtraParams.tr_sub2 %>',
   tr_sub3: '<%= context.click.ExtraParams.tr_sub3 %>',
   tr_sub4: '<%= context.click.ExtraParams.tr_sub4 %>',
   ...
   p5: '<%= context.click.ExtraParams.p5 %>',
